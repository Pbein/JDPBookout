@echo off
REM JDPowerDownloader Launcher - Clean Production Version
...
REM Launch the production application (using the production executable)
cd /d "%SCRIPT_DIR%"
start "" "JDPowerDownloader.exe"
